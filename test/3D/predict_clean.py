...
model = load_model('Loss_Binary_cross_entropy_loss_time_Thu_Jun_15_23_48_10_2023.h5',compile=False)
...
for i,df in enumerate(all_df):
  if (i==0):  
    ...
    convert_nrrd(df,model,path_to,Width,Length,name_excel)