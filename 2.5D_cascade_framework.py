...
os.chdir("X:/Ruben/TESE/New_training_Unet/2.5D_model_scripts") 
...
for index, *ans in zip(range(number_folds), *[cycle(folds)] * (number_folds+1)):
    ...
    model=build_unet((Width,Length,3),1)
    print(model.summary())
    ...
    if not only_peri:
        ...
        path_model="X:/Ruben/TESE/New_training_Unet/Models_only_pub_dset/Mix_datasets/Only_pericardium/models/2.5D_Unet/BCE/L0_W2000_calc_augm_tif/Sat May 20 16_25_55 2023" 
        model = load_model(os.path.join(path_model,'L0_W2000_calc_augm_tif_2.5D_time_Sat_May_20_16_25_55_2023.h5'),compile=False)     
    else:
    ...
    model_path="X:/Ruben/TESE/New_training_Unet/Models_only_pub_dset/Mix_datasets/"+str(name_path)+"/models/2.5D_Unet/BCE/L0_W2000_calc_augm_tif"
...
#     #       return lr * tf.math.exp(-0.1)
    ...
    name_str=model_path.split('\\')[0].split('/')[-1]+'_2.5D'
...
# run the second script
   ...
   runfile(os.path.join('X:/Ruben/TESE/New_training_Unet/2.5D_model_scripts','2.5D_cascade_framework.py'))
