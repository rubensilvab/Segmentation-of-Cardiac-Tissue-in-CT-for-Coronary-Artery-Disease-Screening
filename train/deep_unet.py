# -*- coding: utf-8 -*-
"""
Created on Thu Apr 27 16:41:47 2023
...
def build_unet(input_shape, n_classes):
    ...
    out1 = Conv2D(n_classes, 1, padding="same", activation=activation)(d5)  #Change the activation based on n_classes
    # out2 = Conv2D(n_classes, 1, padding="same", activation=activation)(d3)  #Change the activation based on n_classes
    # out3 = Conv2D(n_classes, 1, padding="same", activation=activation)(d2)  #Change the activation based on n_classes
    
    
    
    print(activation)

    model = Model(inputs, outputs=[out1], name="U-Net")
    return model
