...
os.chdir("X:/Ruben/TESE/New_training_Unet/2.5d_5slices") 
...
for index, *ans in zip(range(number_folds), *[cycle(folds)] * (number_folds+1)):
    ...
    model=build_unet((Width,Length,5),1)
    print(model.summary())
    ...
    if not only_peri:
        ...
        path_model="X:/Ruben/TESE/New_training_Unet/Models_only_pub_dset/Mix_datasets/Only_pericardium/models/2.5D_Unet_5s/DICE/L0_W2000_calc_augm_tif/Thu Jun 29 23_26_29 2023" 
        model = load_model(os.path.join(path_model,'L0_W2000_calc_augm_tif_2.5D_time_Thu_Jun_29_23_26_29_2023.h5'),compile=False)     
    else:
    ...
    model_path="X:/Ruben/TESE/New_training_Unet/Models_only_pub_dset/Mix_datasets/"+str(name_path)+"/models/2.5D_Unet_5s/DICE/L0_W2000_calc_augm_tif"
...
# run the second script
   ...
   runfile(os.path.join('X:/Ruben/TESE/New_training_Unet/2.5d_5slices','2.5D_cascade_framework.py'))
